# Terms of Service for GoShopper AI
...
By accessing or using the GoShopper AI mobile application ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.

## 2. Description of Service

GoShopper AI is a mobile application that provides:
...
### 4.1 Permitted Use
You may use the App for personal, non-commercial purposes to:
...
You may NOT:
- Upload false or fraudulent receipts
...
- You represent that your content does not violate any laws

### 5.2 Our Content
- The App, including all code, design, and features, is our property
- Our trademarks and logos are protected
- You receive a limited, non-exclusive license to use the App

## 6. Privacy

Your use of the App is governed by our Privacy Policy, which is incorporated into these Terms by reference. Please review the Privacy Policy to understand our data practices.

## 7. Accuracy of Information

### 7.1 OCR Accuracy
- Receipt scanning uses AI and may contain errors
- You are responsible for verifying scanned data
- We do not guarantee 100% OCR accuracy

### 7.2 Price Information
- Prices are based on your scanned receipts
- We do not verify or guarantee price accuracy
...
- Spending insights are for informational purposes only
...
Our total liability to you for any claims shall not exceed the amount you paid us in the past 12 months (which is $0 for a free app).
...
- Change pricing (with notice for paid features)
- Impose usage limits

## 13. Intellectual Property

### 13.1 Copyright
All App content is protected by copyright and other laws. Unauthorized use may violate copyright, trademark, and other laws.

### 13.2 Trademarks
"GoShopper AI" and related logos are our trademarks. You may not use them without permission.

## 14. Geographic Restrictions

### 14.1 Availability
The App is designed primarily for users in the Democratic Republic of Congo but may be available in other regions.

### 14.2 Local Laws
You are responsible for complying with local laws regarding the use of the App.
...
Before filing a claim, contact us to resolve the issue informally:
- Email: legal@goshopperai.com
...
- You lose access to all App features
...
**Website:** https://goshopperai.com/terms  
...
- Apple is not liable for the App
...
- Google is not liable for the App

---

## Summary in French (Résumé en Français)

### Conditions d'Utilisation - Points Clés

**Utilisation Acceptée:**
- Usage personnel et non-commercial
- Scanner vos propres tickets
- Suivre vos dépenses

**Utilisation Interdite:**
- Activités frauduleuses
- Téléchargement de faux tickets
- Usage commercial non autorisé

**Propriété:**
- Vous possédez vos données
- Nous possédons l'application

**Limitations:**
- Service fourni "tel quel"
- Pas de garantie d'exactitude à 100%
- Responsabilité limitée

**Résiliation:**
- Vous pouvez supprimer votre compte à tout moment
- Nous pouvons suspendre les comptes en cas de violation

**Contact:**
legal@goshopperai.com

---

## Acknowledgment

BY USING GOSHOPPER AI, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF SERVICE AND AGREE TO BE BOUND BY THEM.
