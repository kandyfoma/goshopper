...
exports.checkPriceAlerts = exports.getPhoneAuthToken = exports.checkIdentifierAvailabilityV2 = exports.deleteUserData = exports.checkIdentifierAvailability = exports.completeRegistration = exports.verifyCode = exports.sendVerificationCode = exports.getSmartPriceComparison = exports.getPriceHistory = exports.getPriceComparison = exports.savePriceData = exports.sendManualExpirationWarning = exports.checkExpirationWarnings = exports.manuallyRenewSubscription = exports.processAutoRenewals = exports.getUserStats = exports.extendTrial = exports.checkExpiredSubscriptions = exports.cancelSubscription = exports.getSubscriptionPricing = exports.renewSubscription = exports.downgradeSubscription = exports.upgradeSubscription = exports.recordScanUsage = exports.getSubscriptionStatus = exports.listDeadLetterEvents = exports.getWebhookStats = exports.retryWebhookEvent = exports.processWebhookRetries = exports.retryRefund = exports.listUserRefunds = exports.getRefundStatus = exports.requestRefund = exports.purchaseScanPack = exports.activateSubscriptionFromRailway = exports.mokoPaymentWebhook = exports.verifyMokoPayment = exports.initiateMokoPayment = exports.retryFailedScans = exports.cancelPendingScan = exports.getUserPendingScans = exports.getPendingScanStatus = exports.onPendingScanCreated = exports.createPendingScan = exports.quickExtractReceipt = exports.parseReceiptVideo = exports.parseReceiptMulti = exports.parseReceiptV2 = exports.parseReceipt = void 0;
exports.adminPanel = exports.countCityItems = exports.calculateUserMLFeatures = exports.updateUserBehaviorProfile = exports.testAppleNotification = exports.appleNotifications = exports.manualCleanupUserData = exports.cleanupOldUserData = exports.searchMasterProducts = exports.addProductMapping = exports.initializeMasterProducts = exports.searchCityItems = exports.backfillCityItemCategories = exports.cleanupDeletedReceiptItems = exports.getCityItems = exports.rebuildItemsAggregation = exports.aggregateItemsOnReceipt = exports.getSpendingSuggestions = exports.processNLQuery = exports.sendManualFeatureUnlockNotification = exports.onSubscriptionPlanChange = exports.sendManualMonthlySummary = exports.sendMonthlySummaries = exports.removePriceAlert = exports.setPriceAlert = exports.onCityItemPriceUpdate = exports.sendManualPaymentNotification = exports.sendUpgradeOfferToUser = exports.sendMonthlyUpgradeOffers = exports.sendWelcomeToNewUser = exports.sendUpgradeProposalToUser = exports.sendUpgradeProposals = exports.sendCategoryInsightToUser = exports.sendCategoryInsights = exports.resetBudgetWarnings = exports.sendManualBudgetWarning = exports.onReceiptCreatedForBudget = exports.sendManualScanLimitWarning = exports.resetScanLimitWarnings = exports.onReceiptCreated = exports.sendManualGracePeriodReminder = exports.checkGracePeriodReminders = exports.checkSubscriptionExpiration = exports.sendAdminBroadcast = exports.sendSyncCompleteNotification = exports.sendAchievementNotification = exports.sendWeeklySavingsTips = exports.getUserAlerts = exports.createPriceAlert = exports.scheduledAlertCheck = void 0;
exports.adminDeleteUser = exports.getAdminStats = exports.setUserAdminStatus = exports.getAllUsers = exports.isAdmin = void 0;
...
var backgroundProcessing_1 = require("./receipt/backgroundProcessing");
Object.defineProperty(exports, "createPendingScan", { enumerable: true, get: function () { return backgroundProcessing_1.createPendingScan; } });
Object.defineProperty(exports, "onPendingScanCreated", { enumerable: true, get: function () { return backgroundProcessing_1.onPendingScanCreated; } });
Object.defineProperty(exports, "getPendingScanStatus", { enumerable: true, get: function () { return backgroundProcessing_1.getPendingScanStatus; } });
Object.defineProperty(exports, "getUserPendingScans", { enumerable: true, get: function () { return backgroundProcessing_1.getUserPendingScans; } });
Object.defineProperty(exports, "cancelPendingScan", { enumerable: true, get: function () { return backgroundProcessing_1.cancelPendingScan; } });
Object.defineProperty(exports, "retryFailedScans", { enumerable: true, get: function () { return backgroundProcessing_1.retryFailedScans; } });
// Payment functions
...
var cleanup_1 = require("./auth/cleanup");
Object.defineProperty(exports, "deleteUserData", { enumerable: true, get: function () { return cleanup_1.deleteUserData; } });
Object.defineProperty(exports, "checkIdentifierAvailabilityV2", { enumerable: true, get: function () { return cleanup_1.checkIdentifierAvailabilityV2; } });
var phoneAuth_1 = require("./auth/phoneAuth");
Object.defineProperty(exports, "getPhoneAuthToken", { enumerable: true, get: function () { return phoneAuth_1.getPhoneAuthToken; } });
...
var budgetNotifications_1 = require("./notifications/budgetNotifications");
Object.defineProperty(exports, "onReceiptCreatedForBudget", { enumerable: true, get: function () { return budgetNotifications_1.onReceiptCreatedForBudget; } });
Object.defineProperty(exports, "sendManualBudgetWarning", { enumerable: true, get: function () { return budgetNotifications_1.sendManualBudgetWarning; } });
Object.defineProperty(exports, "resetBudgetWarnings", { enumerable: true, get: function () { return budgetNotifications_1.resetBudgetWarnings; } });
// Category insights for premium users
var categoryInsightsNotifications_1 = require("./notifications/categoryInsightsNotifications");
Object.defineProperty(exports, "sendCategoryInsights", { enumerable: true, get: function () { return categoryInsightsNotifications_1.sendCategoryInsights; } });
Object.defineProperty(exports, "sendCategoryInsightToUser", { enumerable: true, get: function () { return categoryInsightsNotifications_1.sendCategoryInsightToUser; } });
// Welcome notifications for new users
var welcomeNotifications_1 = require("./notifications/welcomeNotifications");
Object.defineProperty(exports, "sendUpgradeProposals", { enumerable: true, get: function () { return welcomeNotifications_1.sendUpgradeProposals; } });
Object.defineProperty(exports, "sendUpgradeProposalToUser", { enumerable: true, get: function () { return welcomeNotifications_1.sendUpgradeProposalToUser; } });
Object.defineProperty(exports, "sendWelcomeToNewUser", { enumerable: true, get: function () { return welcomeNotifications_1.sendWelcomeToNewUser; } });
// Monthly upgrade offers (30th of each month)
var monthlyUpgradeNotifications_1 = require("./notifications/monthlyUpgradeNotifications");
Object.defineProperty(exports, "sendMonthlyUpgradeOffers", { enumerable: true, get: function () { return monthlyUpgradeNotifications_1.sendMonthlyUpgradeOffers; } });
Object.defineProperty(exports, "sendUpgradeOfferToUser", { enumerable: true, get: function () { return monthlyUpgradeNotifications_1.sendUpgradeOfferToUser; } });
...
Object.defineProperty(exports, "backfillCityItemCategories", { enumerable: true, get: function () { return itemAggregation_1.backfillCityItemCategories; } });
// Item Search functions
var searchCityItems_1 = require("./items/searchCityItems");
Object.defineProperty(exports, "searchCityItems", { enumerable: true, get: function () { return searchCityItems_1.searchCityItems; } });
...
// Admin functions
var countCityItems_1 = require("./admin/countCityItems");
Object.defineProperty(exports, "countCityItems", { enumerable: true, get: function () { return countCityItems_1.countCityItems; } });
var index_1 = require("./admin/index");
Object.defineProperty(exports, "adminPanel", { enumerable: true, get: function () { return index_1.adminPanel; } });
var auth_1 = require("./admin/auth");
...
Object.defineProperty(exports, "getAllUsers", { enumerable: true, get: function () { return adminFunctions_1.getAllUsers; } });
Object.defineProperty(exports, "setUserAdminStatus", { enumerable: true, get: function () { return adminFunctions_1.setUserAdminStatus; } });
Object.defineProperty(exports, "getAdminStats", { enumerable: true, get: function () { return adminFunctions_1.getAdminStats; } });
Object.defineProperty(exports, "adminDeleteUser", { enumerable: true, get: function () { return adminFunctions_1.adminDeleteUser; } });
