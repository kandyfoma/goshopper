...
const iconPaths: Record<
  string,
  {outline: React.ReactNode; filled?: React.ReactNode}
> = {
  // Navigation
  home: {
    outline: (
  ...
  receipt: {
    outline: (
      <>
        <Path
          d="M4 2v20l4-2 4 2 4-2 4 2V2l-4 2-4-2-4 2z"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
  ...
  filter: {
    ...
    filled: <Path d="M22 3H2l8 9.46V19l4 2v-8.54L22 3z" fill="currentColor" />,
  },
  // Status
  'check-circle': {
    outline: (
  ...
  hand: {
    outline: (
      <>
        ...
        />
        <Path
          d="M18 8a2 2 0 0 1 4 0v6a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-3.6-3.6a2 2 0 0 1 2.83-2.82L7 15"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
      </>
  ...
  send: {
    ...
    filled: <Path d="M22 2l-7 20-4-9-9-4 20-7z" fill="currentColor" />,
  },
  'message-circle': {
    outline: (
      <Path
...
const Icon: React.FC<IconProps> = ({
  ...
  const iconContent =
    variant === 'filled' && iconData.filled
      ? iconData.filled
      : iconData.outline;

  // Special handling for logo icons that need fill support
  const isLogoIcon = name.startsWith('logo-');
  const svgFill = isLogoIcon ? color : 'none';
  const svgStroke = isLogoIcon ? 'none' : color;
